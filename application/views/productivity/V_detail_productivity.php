										...
										for ($i=0; $i < count($no_unit['no_unit']); $i++){
											...
											<tr>
												...
												if($no_unit['detail'][$i]['response'] == 'avail'){
													...
													$productivity = floatval($produksi) / floatval($work);
												?>
													<td>
														<?php
														if(floatval($productivity) && intval($productivity) != floatval($productivity)){
												...
												?>
												<td>
													<a href="<?php echo base_url().'Productivity/detail_productivity_unit/'.$id_type_unit.'/'.$cn_unit;?>" class="btn btn-primary">
														Detail
													</a>
												</td>
											</tr>
...
<script>
	...
	function search(){
		...
		if(owner == ''){
			...
			window.location.href = '<?= base_url();?>Productivity/search_data_productivity_owner/'+'<?php echo $id_type_unit;?>'+'/'+'<?= $egi;?>'+'/'+owner;
		}
	}
</script>
</body>
