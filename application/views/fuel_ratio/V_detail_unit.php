					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-8">
										<h4>Data CN Unit <?php echo $cn_unit;?> <?php if($periode != ''){ echo 'Periode '.$periode;}else{echo 'Per Day';}?></h4>
									</div>
									<div class="col-4">
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									if(!empty($no_unit)){
										...
										for ($i=0; $i < count($no_unit['no_unit']); $i++){
											...
											$date_activity = $no_unit['tgl_aktifitas'][$i];
											?>
											<tr>
												<td><?php echo $no;?></td>
												<td><?php echo $cn_unit;?></td>
												<td><?php echo $type_unit;?></td>
												<td><?php echo $date_activity;?></td>
...
<script>
	...
	function search() {
		...
		if (start_date == '' || end_date == '') {
			...
			window.location.href = '<?= base_url();?>Fuel_ratio/detail_fuel_ratio_unit_range/' + '<?php echo $id_type_unit;?>' + '/' + '<?php echo $cn_unit;?>' + '/' + start_date + '/' + end_date;
		}
	}
</script>
</body>
