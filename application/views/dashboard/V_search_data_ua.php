					...
					<div class="col-12">
						<div class="card">
							<div class="card-header border-0">
								<h4 class="">Top 10 Problem UA (<?php echo $type_unit;?>) Periode <?php echo $tgl;?></h4>
							</div>
...
<script>
	...
	function search(){
		...
		if(start_date == '' || end_date == ''){
			...
			window.location.href = '<?= base_url();?>Dashboard/search_data_ua_range/'+start_date+'/'+end_date+'/'+'<?= $type_unit;?>';
		}
	}
	function detail(id){
		$.ajax({
