					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-8">
										<h4 class="">Data CN Unit Breakdown Status (<?php echo $breakdown;?>) Periode (<?php echo $tgl;?>)</h4>
									</div>
									<div class="col-4">
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									if(!empty($no_unit['no_unit'])){
										...
										for ($i=0; $i < count($no_unit['no_unit']); $i++){
											...
											$breakdown_status = $no_unit['breakdown_status'][$i];
											$times = $no_unit['times'][$i];
											?>
											<tr>
												<td><?php echo $no;?></td>
												...
												<td><?php echo $breakdown_status;?></td>
...
<script>
	...
	function search(){
		...
		if(start_date == '' || end_date == ''){
			...
			window.location.href = '<?= base_url();?>Dashboard/search_data_breakdown_range/'+start_date+'/'+end_date+'/'+'<?= $breakdown;?>';
		}
	}
</script>
</body>
