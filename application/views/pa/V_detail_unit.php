					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-8">
										<h4 class="">Data CN Unit (<?php echo $no_unit;?>) <?php if($periode != ''){ echo 'Periode '.$periode;}else{echo 'Per Day';}?></h4>
									</div>
									<div class="col-4">
...
<script>
	...
	function search(){
		...
		if(start_date == '' || end_date == ''){
			...
			window.location.href = '<?= base_url();?>Pa/detail_pa_unit_range/'+'<?php echo $id_type_unit;?>'+'/'+'<?php echo $no_unit;?>'+'/'+start_date+'/'+end_date;
		}
	}
</script>
