					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-8">
										<h4 class="">Data CN Unit (<?php echo $cn_unit;?>) <?php if($periode != '') echo 'Periode '.$periode;?></h4>
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									if(!empty($no_unit)){
										...
										for ($i=0; $i < count($no_unit['no_unit']); $i++){
											...
											$tgl_aktifitas = $no_unit['tgl_aktifitas'][$i];
...
<script>
	...
	function search(){
		...
		if(start_date == '' || end_date == ''){
			...
			window.location.href = '<?= base_url();?>Produksi/detail_unit_range/'+'<?php echo $id_mat;?>'+'/'+'<?= $id_block;?>'+'/'+'<?php echo $cn_unit;?>'+'/'+start_date+'/'+end_date;
		}
	}
</script>
</body>
