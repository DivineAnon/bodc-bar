					...
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-8">
										<h4 class="">Data CN Unit PIT (<?php echo $block_name;?>) <?php if($owner_name !='') echo ' Owner ('.$owner_name.')';?></h4>
									</div>
									<div class="col-4">
								...
								<table id="example2" class="table table-bordered table-hover">
									...
									if(!empty($no_unit)){
										...
										for ($i=0; $i < count($no_unit['no_unit']); $i++){
											...
											$total = array_sum($no_unit['total'][$cn_unit]);
											?>
											<tr>
												<td><?php echo $no;?></td>
												...
												<td>
													<a href="<?php echo base_url().'Produksi/detail_unit/'.$id_mat.'/'.$id_block.'/'.$cn_unit	;?>" class="btn btn-primary">
														Detail
													</a>
												</td>
											</tr>
...
<script>
	...
	function search(){
		...
		if(owner == ''){
			...
			window.location.href = '<?= base_url();?>Produksi/search_data_produksi_owner/'+'<?php echo $id_mat;?>'+'/'+'<?= $id_block;?>'+'/'+owner;
		}
	}
</script>
</body>
